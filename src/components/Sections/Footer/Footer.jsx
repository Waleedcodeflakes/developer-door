    ...
    return (
        <section className='w-full bg-[#CCCCCC1A]'>
            ...
            <div onClick={() => setShowPopup(false)} className='w-full h-screen bg-[#00000080] fixed top-0 left-0 z-50 overflow-y-auto flex justify-center items-center'>
                ...
                <h1 className='poppins-semibold text-[34px] sm:text-[42px] text-[#E35D49] text-center'>Developer Door Stylist!</h1>
            ...
            <div className='w-[92%] m-auto'>
                <div className='flex-wrap sm:flex justify-between'>
                    <div className='py-6 w-full sm:w-[60%]'>
                        {/* <Link to="/" className='poppins-bold text-[#E35D49] text-[38px] sm:text-[36px]'>Developer Door Stylist</Link> */}
                ...
                <div className='flex-wrap md:flex w-full justify-between py-8'>
                    <div><p className='poppins-regular text-base text-[#333333]'>© {new Date().getFullYear()} Developer Door Stylist. All rights reserved.</p></div>
